...
wh_query <- "https://webhose.io/search?token=49135022-cfa8-4a85-9493-1bb2d4e402a9&format=json&q=echopixel&ts=1482189320017"
echo  <- as.data.frame(fromJSON(wh_query, flatten = TRUE))
zspace.df <- data.frame(zspace)
...
t_source <- tw.df2$posts.thread.site
